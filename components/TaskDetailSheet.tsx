...
import { CheckSquare, MessageSquare, Clock, Calendar, Play, Trash2, Edit3, X } from 'lucide-react';
...
interface Tarea {
  ...
  dueDate: string | null;
  proyecto?: { id: string; title: string };
...
export const TaskDetailSheet: React.FC<TaskDetailSheetProps> = ({ task, isOpen, onClose, onUpdate, onDelete }) => {
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-start">
          <div className="flex-1">
            ...
            {isEditing ? (
              <input
                ...
                className="w-full text-xl font-bold text-gray-900 border-b border-elio-yellow outline-none mt-1"
              />
            ) : (
          ...
          <div className="flex space-x-2 ml-4">
            {!isEditing && (
              <>
                <button onClick={handleStartEdit} className="p-2 hover:bg-gray-100 rounded-lg text-gray-500 hover:text-blue-600">
                  <Edit3 size={18} />
                </button>
                <button onClick={handleDelete} className="p-2 hover:bg-red-50 rounded-lg text-gray-500 hover:text-red-600">
                  <Trash2 size={18} />
                </button>
              </>
            )}
        ...
        {isEditing ? (
          <div className="flex space-x-3">
            <button 
              ...
              className="flex-1 bg-elio-yellow hover:bg-elio-yellow-hover text-white py-2 rounded-lg font-medium"
            >
              Guardar Cambios
            </button>
            <button 
        ...
        {isEditing && (
          <div>
            ...
            <textarea
              ...
              className="w-full mt-1 p-3 border border-gray-200 rounded-lg text-sm outline-none focus:border-elio-yellow"
              rows={3}
